$(document).ready(function () {
    ...
    $(".underAvatarButton").addClass("btn btn-default text-center col-md-6 col-sm-6 col-xs-6");
    ...
    $(".elementOfListInProfile").addClass("challenge col-lg-4 col-md-4 col-sm-6 col-xs-12");
