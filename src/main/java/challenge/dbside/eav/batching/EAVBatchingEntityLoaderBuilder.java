...
/**
 * The contract for building {@link UniqueEntityLoader} capable of performing
 * batch-fetch loading. Intention is to build these instances, by first calling
 * the static {@link #getBuilder}, and then calling the appropriate
...
//				return LegacyBatchingEntityLoaderBuilder.INSTANCE;
    ...
    /**
     * Builds a batch-fetch capable loader based on the given persister,
     * lock-mode, etc.
     *
