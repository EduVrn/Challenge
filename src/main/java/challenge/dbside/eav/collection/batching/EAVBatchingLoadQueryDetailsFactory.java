...
public class EAVBatchingLoadQueryDetailsFactory {
     ...
     * @param keyColumnNames The columns to load the entity by (the PK columns
     * or some other unique set of columns)
     * @param buildingParameters And influencers that would affect the generated
     * SQL (mostly we are concerned with those that add additional joins here)
