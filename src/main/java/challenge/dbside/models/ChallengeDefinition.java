...
public class ChallengeDefinition extends BaseEntity implements Commentable {
    ...
    public User getCreator() {
    	Integer id = IdAttrGet.refCreatedChal();
    	List<DBSource> list = (List<DBSource>)getDataSource().getRelations_r().get(id);
    	
    	DBSource source = (DBSource)(list.get(0));    	
    ...
    public void setCreator(User creator) {
    	getDataSource().getRelations_r().remove(IdAttrGet.refCreatedChal());
